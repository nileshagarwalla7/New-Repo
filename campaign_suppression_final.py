					...
					if map_dict[key] == None :
						...
						while (j <= len(z)-2):
							...
							if (df_name == 'traveler'):	#when the table name is traveler
								...
								set_dynamic_content_value(dynamic_content_value, "{}_1".format(attribute_name),
														  str(trav_attri))
							else :
								...
								set_dynamic_content_value(dynamic_content_value,"{}_{}".format(attribute_name,
																							   var_source_connection), str(value_re))
							j+=2
...
list2_concat = list(zip(cid_ls,filename_mod_ls,path_mod_ls,sid_ls))
#print(list1_concat)
...
output_rdd_path = "s3n://big-data-analytics-scratch-prod/project_traveler_profile/affine/alphaToSqlTest/rdd_path/{}/{}".format(locale_name,LaunchDate)
